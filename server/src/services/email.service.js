...
export const emailTemplates = {
  resetPassword: (name, link) => ({
    subject: 'Quarters — Reset your password',
    html: `<div style="font-family:sans-serif;max-width:480px">
      <h2>Hi ${name},</h2>
      <p>We received a request to reset your Quarters password. This link is valid for <b>30 minutes</b>.</p>
  ...
  rentReminder: (name, monthLabel, amount, dueDate) => ({
    subject: `Quarters — Rent reminder for ${monthLabel}`,
    html: `<div style="font-family:sans-serif;max-width:480px">
      <h2>Hi ${name},</h2>
      <p>Your rent of <b>₹${amount}</b> for <b>${monthLabel}</b> is due by <b>${dueDate}</b>.</p>
      <p>Please pay on time to avoid late fees. You can pay online from your Quarters dashboard.</p>
    </div>`,
  }),
  paymentReceipt: (name, monthLabel, amount, txnId) => ({
    subject: `Quarters — Payment received for ${monthLabel}`,
    html: `<div style="font-family:sans-serif;max-width:480px">
