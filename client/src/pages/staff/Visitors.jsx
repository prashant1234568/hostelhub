    ...
    <div className="space-y-6">
      ...
      <Card>
        <div className="flex items-center gap-2.5 sm:max-w-xs">
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-brand-50 dark:bg-brand-500/15 text-brand-600 dark:text-brand-300">
      ...
      <Card>
        {loading ? (
          ...
          <EmptyState icon={ClipboardList} title="No visitors" message="Visitor requests appear here for check-in." />
        ) : (
