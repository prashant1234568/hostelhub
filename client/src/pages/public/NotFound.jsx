...
export default function NotFound() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#f6f8fa] px-5 text-center">
      ...
      <div className="relative">
        <span className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-400 to-brand-600 text-white shadow-[0_10px_24px_-8px_rgba(36,48,71,0.6)]">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link to={home} className="inline-flex h-11 items-center gap-2 rounded-xl bg-brand-600 px-6 text-sm font-semibold text-white shadow-[0_10px_22px_-8px_rgba(36,48,71,0.6)] transition-all hover:-translate-y-0.5 hover:bg-brand-700">
