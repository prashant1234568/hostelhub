...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf8f1] text-slate-900 selection:bg-brand-200">
      {/* Announcement strip */}
      ...
      {/* Nav */}
      <header className="sticky top-0 z-40 border-b border-slate-200/60 bg-[#fdf8f1]/85 backdrop-blur">
        ...
        <Section className="grid items-center gap-12 pt-14 pb-12 lg:grid-cols-[1.05fr_0.95fr] lg:pt-20 lg:pb-16">
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: EASE }}>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link to="/register" className="inline-flex h-12 items-center gap-2 rounded-full bg-brand-600 px-7 font-semibold text-white shadow-[0_14px_30px_-10px_rgba(225,29,72,0.7)] transition-all hover:-translate-y-0.5 hover:bg-brand-700">
