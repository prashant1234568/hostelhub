...
const MEAL_ROWS = [
  { key: 'breakfast', label: 'Breakfast', icon: Coffee, tile: 'bg-amber-50 dark:bg-amber-500/15 text-amber-600 dark:text-amber-300' },
  { key: 'lunch',     label: 'Lunch',     icon: Soup,   tile: 'bg-emerald-50 dark:bg-emerald-500/15 text-emerald-600 dark:text-emerald-300' },
            ...
            <StaggerItem key={m._id} className="h-full">
              <div className="group h-full bg-white dark:bg-surface rounded-2xl border border-slate-200/70 dark:border-white/10 shadow-card hover:shadow-soft hover:-translate-y-0.5 transition-all duration-200 flex flex-col overflow-hidden">
                ...
                <button
                  ...
                  className="border-t border-slate-100 dark:border-white/10 px-5 py-3 inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-brand-600 dark:text-brand-300 hover:bg-brand-50 dark:hover:bg-white/5 transition-colors"
                >
